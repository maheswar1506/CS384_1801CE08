# Project "02" : Notepad by team "Shadow Masters"
# Created by (a) G Maheswar Reddy (1801CE08) (b) P.S.S.Srikar (1801EE31)
from tkinter import *
...
class Notepad:
    ...
    def __init__(self):
        ...
        self.filemenu.add_command(
            label="Save As", command=self.saveasFile)
        self.filemenu.add_separator()
        self.filemenu.add_command(
            label="Exit", command=self.exitApp)
        ...
        self.statsmenu.add_command(
            label="Word Count", command=self.word_count)
        self.statsmenu.add_command(
            label="Char Count", command=self.char_count)
        self.statsmenu.add_command(
